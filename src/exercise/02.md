...
Imperative Programming: How you do something: [writing a function that contains
every step until something is done], [telling the waiter to get a seat at the
empty table in the back of the room, you see has just emptied]

Declarative Programming: What you do: [writing a function that contains built in
stuff just to get the result you want done], [telling the waiter to get a seat
for two]

Declarative Programming approaches almost always built up upon imperative
programming, but it doesn't matter because you don't need to know **how** it is
done.
...
World' element.className = 'container'
```
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Fundamentals%20%E2%9A%9B&e=02%3A%20Intro%20to%20raw%20React%20APIs&em=eising%40sipate.de).
